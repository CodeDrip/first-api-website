  ...
  .then(res => {
    ...
    for (let i = 0; i < smallerArray.length; i++){
      console.log(smallerArray[i])
        ...
        // var selectedModal = document.querySelectorAll('article')[i].id//.pop()
        // var lastTwo = cubeId.substr(cubeId.length - 2);
        // console.log(lastTwo)
        ...
        document.querySelectorAll(`div`)[i].addEventListener("click", function(){
          ...
          var selectedModal = document.querySelectorAll('article')[i].id//.pop()
          var selectedSquare = document.querySelectorAll(`div`)[i].id
